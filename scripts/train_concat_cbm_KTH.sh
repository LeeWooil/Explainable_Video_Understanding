#!/usr/bin/bash
#SBATCH -J KTH_concat_cbm_aligned
#SBATCH --gres=gpu:1
...
PYTHON_SCRIPT="/data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/train_concat_cbm.py"
...
python \
    ...
    --save-dir /data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/runs/CBM_result/KTH/concat_cbm_aligned \
    --use-mlp \
    --loss-mode concept \
