#!/usr/bin/bash
#SBATCH -J KTH_attn_cbm_temp3_aligned
#SBATCH --gres=gpu:1
...
PYTHON_SCRIPT="/data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/train_attn_global_cbm.py"
...
python \
    ...
    --save-dir /data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/runs/CBM_result/KTH/attn_cbm_temp3_aligned \
    --use-mlp \
    --loss-mode concept \
    --deterministic-spatial \
    --attention-temperature 3.0 \
    --proj-steps 3000 \
    --n-iters 30000
