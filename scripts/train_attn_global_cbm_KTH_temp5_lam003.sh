#!/usr/bin/bash
#SBATCH -J KTH_attn_cbm_temp5_lam003_aligned
#SBATCH --gres=gpu:1
...
python \
    ...
    --save-dir /data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/runs/CBM_result/KTH/attn_cbm_temp5_lam003_aligned \
    --use-mlp \
    --loss-mode concept \
