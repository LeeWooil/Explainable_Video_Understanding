#!/usr/bin/bash
#SBATCH -J KTH_local_global_cbm_aligned_block11_multiply_maxpool
#SBATCH --gres=gpu:1
...
PYTHON_SCRIPT="/data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/train_local_global_cbm.py"
...
python \
    ...
    --save-dir /data/lwi2765/repos/XAI/Video_Language_XAI/CBM_training_ver2/runs/CBM_result/KTH/local_global_cbm_aligned_gated \
    --use-mlp \
